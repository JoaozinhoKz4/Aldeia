...
<body class="header-horizontal dark-overlay">
        ...
        <div id="content">
            ...
            <section id="home" class="section h-fullheight bg-dark cover dark">
                ...
                <div class="slider-main slider-kenburns inner-controls">
                    ...
                    <div class="slide">
                        <div class="slide-bg bg-image-holder bg-image-fixed">
                            <img src="assets/img/Banner_Site_Aldeia_01.png" alt="">
                        </div>
                    ...
                    <div class="slide">
                        <div class="slide-bg bg-image-holder bg-image-fixed">
                            <img src="assets/img/Banner_Site_Aldeia_02.png" alt="">
                        </div>
                        <div class="slide-content container text-center">
                    ...
                    <div class="slide">
                        <div class="slide-bg bg-image-holder bg-image-fixed">
                            <img src="assets/img/Banner_Site_Aldeia_03.png" alt="">
                        </div>
                        <div class="slide-content container text-center">
                    ...
                    <div class="slide">
                        <div class="slide-bg bg-image-holder bg-image-fixed">
                            <img src="assets/img/Banner_Site_Aldeia_04.png" alt="">
                        </div>
                        <div class="slide-content container text-center">
                ...
                <div class="slider-main-nav">
                    <div class="slide"><img src="assets/img/Banner_Site_Aldeia_01.png" alt="Escritório Aldeia"></div>
                    <div class="slide"><img src="assets/img/Banner_Site_Aldeia_02.png" alt="Mesas de atendimento 1"></div>
                    <div class="slide"><img src="assets/img/Banner_Site_Aldeia_03.png" alt="Mesas de atendimento 2"></div>
                    <div class="slide"><img src="assets/img/Banner_Site_Aldeia_04.png" alt="Cadeiras na recepção"></div>
                </div>
            ...
            <section id="flats" class="section bg-light pt-0 pb-5">
                ...
                <div class="objects-search bg-dark dark">
                    <div class="bg-image-holder bg-image-fixed zooming"><img src="assets/img/Paralax_Aldeia.png" alt=""></div>
                    <div class="container">
                        <h1 class="mb-1">Encontre o imóvel perfeito para você!</h1>
                        <hr>
                        <form action="./">
                        ...
                        <div id="grid_view" class="tab-pane fade show active" role="tabpanel">
                            ...
                            <div class="objects-grid gutters-sm row">
                                ...
                                foreach ($xml->Imovel as $item) {
                                    ...
                                    } elseif ($item->Valorlocacao != "" && $item->Valorlocacao != 0.00) {
            ...
            <section id="gallery" class="section bg-black cover dark">
                ...
                <div class="carousel-gallery">
                    <a href="#" data-toggle="gallery" data-items="galleryCarouselItems" data-slide="0"><img src="assets/img/Galeria_Aldeia_01.png" alt=""></a>
                    <a href="#" data-toggle="gallery" data-items="galleryCarouselItems" data-slide="1"><img src="assets/img/Galeria_Aldeia_02.png" alt=""></a>
                    <a href="#" data-toggle="gallery" data-items="galleryCarouselItems" data-slide="2"><img src="assets/img/Galeria_Aldeia_03.png" alt=""></a>
                    <a href="#" data-toggle="gallery" data-items="galleryCarouselItems" data-slide="3"><img src="assets/img/Galeria_Aldeia_04.png" alt=""></a>
                    <a href="#" data-toggle="gallery" data-items="galleryCarouselItems" data-slide="4"><img src="assets/img/Galeria_Aldeia_05.png" alt=""></a>
                    <a href="#" data-toggle="gallery" data-items="galleryCarouselItems" data-slide="5"><img src="assets/img/Galeria_Aldeia_06.png" alt=""></a>
                </div>
    ...
    <script>
        var gallerySliderItems = [{
                src: 'assets/img/Banner_Site_Aldeia_01.png',
                w: 1920,
                h: 1080
            },
            {
                src: 'assets/img/Banner_Site_Aldeia_02.png',
                w: 1920,
                h: 1080
            },
            {
                src: 'assets/img/Banner_Site_Aldeia_03.png',
                w: 1920,
                h: 1080
            },
            {
                src: 'assets/img/Banner_Site_Aldeia_04.png',
                w: 1920,
                h: 1080
            },
        ...
        var galleryCarouselItems = [{
                src: 'assets/img/Galeria_Aldeia_01.png',
                w: 801,
                h: 547
            },
            {
                src: 'assets/img/Galeria_Aldeia_02.png',
                w: 801,
                h: 547
            },
            {
                src: 'assets/img/Galeria_Aldeia_03.png',
                w: 801,
                h: 547
            },
            {
                src: 'assets/img/Galeria_Aldeia_04.png',
                w: 801,
                h: 547
            },
            {
                src: 'assets/img/Galeria_Aldeia_05.png',
                w: 801,
                h: 547
            },
            {
                src: 'assets/img/Galeria_Aldeia_06.png',
                w: 801,
                h: 547
            }
        ];
    ...
    <!-- JS Google Map -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBrhIdBz8zjIqJFKapaPLlhmnFj6IHDQ7c&callback=initMap" async defer></script>
